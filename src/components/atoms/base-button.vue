...
<template>
  <button
    ...
    class="px-4 py-2 inline-flex relative w-full disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-300 disabled:border-gray-200 cursor-pointer tracking-wide select-none appearance-none items-center justify-center rounded-[5px] focus:outline-none"
    v-bind="$attrs"
  >
