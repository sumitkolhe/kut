...
<template>
  <footer class="bg-gray-100 dark:bg-gray-900 bottom-0 w-full border-t dark:border-gray-700 px-6">
        ...
        <div class="w-auto cursor-pointer order-1">
          <div class="relative">
            <div class="absolute inset-y-0 left-0 flex items-center pl-2.5">
              ...
              />
              <Icon v-else name="line-md:moon" size="20" class="text-gray-900 dark:text-gray-500" />
            </div>
            <select
              id="icon-prefix"
              v-model="isDarkTheme"
