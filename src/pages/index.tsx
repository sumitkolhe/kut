  ...
  return (
    <>
      <div className="layout">
        <div className="hero">
          <h1 className="hero__title text-white">Trym</h1>
            ...
            <NextLink href="/en-us/components">
              <a>
                <Card shadow className="feature__card" width="100%">
                  <h4 className="feature__title  text-3xl">
                    <div className="feature__icon">
                      <PackageIcon />
                    </div>
                    Components
                  </h4>
                  <p className="feature__description">Ever-increasing list of concise and aesthetic components.</p>
                </Card>
              </a>
            </NextLink>
          </Grid>
            ...
            <NextLink href="/en-us/customization">
              <a>
                <Card shadow className="feature__card" width="100%">
                  ...
                  <p className="feature__description">Configure sizes, colors, appearances, shapes, and more.</p>
                </Card>
              </a>
            </NextLink>
          </Grid>
          <Grid xs={24} md={8}>
            <a href="https://github.com/geist-org/react" target="_blank" rel="noreferrer">
              <Card shadow className="feature__card" width="100%">
                <h4 className="feature__title">
                  <div className="feature__icon">
                    <GitHubIcon />
                ...
                <p className="feature__description">Geist is open sourced and available free under MIT licence.</p>
              </Card>
            </a>
          </Grid>
        </Grid.Container>
      ...
      <style jsx>{`
        .layout {
          min-height: calc(100vh - var(--geist-page-nav-height) - var(--geist-page-tab-height));
